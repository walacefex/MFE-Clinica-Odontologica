...
/* metabox serviços em destistas */
function dentista_mt(){
	...
	array_push($title_servicos, get_the_title());
    array_push($id_servicos, get_the_ID());

    endwhile;
	wp_reset_query();
	
	$servicos = array_combine($id_servicos, $title_servicos);

    $metabox = new Odin_Metabox(
        'servicos', // Slug/ID do Metabox (obrigatório)
        'Serviços', // Nome do Metabox  (obrigatório)
        'dentista', // Slug do Post Type, sendo possível enviar apenas um valor ou um array com vários (opcional)
    ...
    $metabox->set_fields(
        array(
            array(
                'id' => 'servicos1', // Obrigatório
                'label' => __('Serviços 1', 'odin'), // Obrigatório
            ...
            array(
                'id' => 'servicos2', // Obrigatório
                'label' => __('Serviços 2', 'odin'), // Obrigatório
                'type' => 'select', // Obrigatório
