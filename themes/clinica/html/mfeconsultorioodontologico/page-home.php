...
<div class="row mx-auto">
        <div class="fundo-azul-gradiente col-6 col-md-3">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/implantes.png" class="img-fluid py-lg-4 py-md-4 py-2 border-bottom" alt="Implates">
            <h3 class="text-white font-weight-bold h5">Implantes</h3>
        </div>
        <div class="fundo-azul-gradiente col-6 col-md-3">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/facetas-elentes-ceramicas.png" class="img-fluid py-lg-4 py-md-4 py-2 border-bottom" alt="facetas e lentes cerâmicas">
            <h3 class="text-white font-weight-bold h5">Facetas e Lentes
            Cerâmicas</h3>
        </div>
        <div class="fundo-azul-gradiente col-6 col-md-3">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/ortodontia.png"  class="img-fluid py-lg-4 py-md-4 py-2 border-bottom" alt="ortodontia">
            <h3 class="text-white font-weight-bold h5">Ortodontia</h3>
        </div>
        <div class="fundo-azul-gradiente col-6 col-md-3">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/endodontia.png"  class="img-fluid py-lg-4 py-md-4 py-2 border-bottom" alt="endodontia">
            <h3 class="text-white font-weight-bold h5">Endodontia</h3>
        </div>
<div class="w-100 d-none d-md-block"></div>
        <div  class="fundo-azul-gradiente col-6 col-md-3 mt-2">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/fios-de-sustentacao.png"  class="img-fluid py-lg-4 py-md-4 py-2 border-bottom" alt="fios de sustentacao">
            <h3 class="text-white font-weight-bold h5">Fios de <br>
            sustentação</h3>
        </div>
        <div class="fundo-azul-gradiente col-6 col-md-3 mt-2">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/botox.png"  class="img-fluid py-lg-4 py-md-4 py-2 border-bottom" alt="botox">
            <h3 class="text-white font-weight-bold h5">Botox</h3>
        </div>
        <div class="fundo-azul-gradiente col-6 col-md-3 mt-2">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/proteses.png"  class="img-fluid py-lg-4 py-md-4 py-2 border-bottom" alt="próteses">    
            <h3 class="text-white font-weight-bold h5">Próteses</h3>
        </div>
        <div class="fundo-azul-gradiente col-6 col-md-3 mt-2">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/cirurgia-bucomaxilofacial.png"  class="img-fluid py-lg-4 py-md-4 py-2 border-bottom" alt="cirurgia bucomaxilofacial">   
    ...
    <div class="container">
        ...
        <div class="row py-3">
            <div class="col-12 col-md-6 col-lg-6">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/img/consultorio.png" alt="Consultório da clinica odontologia" class="img-fluid">
            </div>
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
...
<section class="container">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/materiais-de-consultorio.png" alt="Materiais de consultorio desntista para estudantes da USP" class="img-fluid">
        </div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner d-flex">
            ...
            <div class="card text-center bg-transparent border-0">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/img/boy.png" class="card-img-top mx-auto comentario-img rounded-circle" alt="...">
            </div>
            </div>
...
<section class="container my-3">
  ...
  <img src="<?php echo get_stylesheet_directory_uri() ?>/img/entrada-da-clinica.png" class="img-fluid card-img-top" alt="Entrada da Clinica">
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary">Leia Mais</a>
        ...
        <div class="col-md-4">
            <div class="card border-0" style="width: 18rem;">
  <img src="<?php echo get_stylesheet_directory_uri() ?>/img/consultorio-de-lado.png" class="card-img-top img-fluid" alt="Consultorio odontologico">
  <div class="card-body">
    <h5 class="card-title font-weight-bold">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Leia Mais</a>
        ...
        <div class="col-md-4">
            <div class="card border-0" style="width: 18rem;">
  <img src="<?php echo get_stylesheet_directory_uri() ?>/img/materiais-de-consultorio.png" class="img-fluid card-img-top" alt="materiais de consutlorio">
  <div class="card-body">
    <h5 class="card-title font-weight-bold">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Leia Mais</a>
